...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_usuarios_usuarios__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_usuarios_usuarios__ = __webpack_require__(34);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UsuariosProvider = /** @class */ (function () {
  ...
  */
    ...
    //Votação de enquetes
    UsuariosProvider.prototype.votacao = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]();
            headers.append('Content-Type', 'application/json');
            _this.http.post(_this.url + '/votos', JSON.stringify(data), { headers: headers })
                .subscribe(function (res) {
                var data = res.json();
                resolve(data);
            }, function (err) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__canal_direto_canal_direto__ = __webpack_require__(56);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__chamados_chamados__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__enquetes_enquetes__ = __webpack_require__(58);
...
var MeuVereadorPage = /** @class */ (function () {
    ...
    MeuVereadorPage.prototype.sair = function () {
...
var MandatoPage = /** @class */ (function () {
    ...
    MandatoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-mandato',template:/*ion-inline-start:"C:\xampp\htdocs\Aplicativo-\src\pages\mandato\mandato.html"*/'<ion-header>\n\n  <ion-navbar color="camara">\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-buttons start>\n\n      <button ion-button icon-only>\n\n        <ion-icon name="arrow-back"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title>\n\n      Mandato\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content>\n\n  \n\n    <iframe src="https://www.erechim.rs.leg.br/"></iframe>\n\n  \n\n</ion-content>'/*ion-inline-end:"C:\xampp\htdocs\Aplicativo-\src\pages\mandato\mandato.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]])
    ], MandatoPage);
    return MandatoPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chamados_chamados__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__meu_vereador_meu_vereador__ = __webpack_require__(43);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__chamados_chamados__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__c_mara_c_mara__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_usuarios_usuarios__ = __webpack_require__(34);
...
var EnquetesPage = /** @class */ (function () {
    function EnquetesPage(navCtrl, navParams, usuariosProvider, toast, formBuilder) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.usuariosProvider = usuariosProvider;
        this.toast = toast;
    ...
    EnquetesPage.prototype.refresh = function (enquetes) {
        throw new Error("Method not implemented.");
    };
    //Enviar comentario e votação
    EnquetesPage.prototype.votacaoEnquete = function () {
        var _this = this;
        this.enqueteVotos = this.validaVotacao.value;
        this.usuariosProvider.votacao(this.enqueteVotos).then(function (result) {
            console.log(result);
            _this.validaVotacao.reset();
        }, function (err) {
            console.log(err);
        });
    };
